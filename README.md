...
one index "spot", [0], [1], [2]...etc.
Secondly, the size of an element is also dependent on the data type used, in this case integer. An integer is typically 4 bytes, however we can clarify this with the standard library function sizeof(), which I have called in main.
